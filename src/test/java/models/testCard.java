...
public class testCard {
    ...
    public void testToString(){
        Card c1 = new Card(5, Suit.Clubs, Card.getHtmlString(5, Suit.Clubs));
        assertEquals("5 \u2663", c1.toString());

        Card c2 = new Card(5, Suit.Hearts, Card.getHtmlString(5, Suit.Hearts));
        assertEquals("5 \u2665", c2.toString());

        Card c3 = new Card(5, Suit.Spades, Card.getHtmlString(5, Suit.Spades));
